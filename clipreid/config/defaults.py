...
# -----------------------------------------------------------------------------
# Prompt-to-part plug-in / cab-body part memory
# -----------------------------------------------------------------------------
_C.PART_MEMORY = CN()
_C.PART_MEMORY.ENABLED = False
_C.PART_MEMORY.CAB_MASK_ROOT = ""
_C.PART_MEMORY.BODY_MASK_ROOT = ""
_C.PART_MEMORY.BODY_FALLBACK_MASK_ROOT = ""
_C.PART_MEMORY.SOFT_MASK = True
_C.PART_MEMORY.MASK_THRESHOLD = 0.0
_C.PART_MEMORY.BINARY_POOLING = False
_C.PART_MEMORY.MIN_PART_RATIO = 0.01
_C.PART_MEMORY.PART_VALIDITY_ENABLED = True
_C.PART_MEMORY.CAB_INVALID_VIEWIDS = []
_C.PART_MEMORY.BODY_EXCLUSIVE_FROM_CAB = False
_C.PART_MEMORY.BODY_VALID_AREA_MINUS_CAB = False
_C.PART_MEMORY.POOL_BETA = 0.0
_C.PART_MEMORY.GLOBAL_WEIGHT = 1.0
_C.PART_MEMORY.CAB_WEIGHT = 0.5
_C.PART_MEMORY.BODY_WEIGHT = 0.5
_C.PART_MEMORY.CAB_LOSS_WEIGHT = 0.5
_C.PART_MEMORY.BODY_LOSS_WEIGHT = 0.5
_C.PART_MEMORY.MASK_DROPOUT = 0.0
_C.PART_MEMORY.MEMORY_MOMENTUM = 0.2
_C.PART_MEMORY.MEMORY_TEMP = 0.05
_C.PART_MEMORY.ONLINE_MASK = False
_C.PART_MEMORY.ONLINE_MASK_SOURCE = "adapter"
_C.PART_MEMORY.ONLINE_ADAPTER_PATH = ""
_C.PART_MEMORY.TRAIN_MAIN_FEATURE = "fused"
_C.PART_MEMORY.MEMORY_FEATURE = "fused"
_C.PART_MEMORY.TEST_FEATURE = "fused"
